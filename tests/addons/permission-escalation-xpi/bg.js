...
// injection's target tab kind is semantic), so each escalates for a person to judge
// per occurrence. (scripting.executeScript grounds "scripting" itself, which is
// declared, so scripting is dropped deterministically and never escalates.)
