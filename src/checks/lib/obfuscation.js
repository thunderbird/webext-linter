...
//
// Minification is a SEPARATE, geometric signal (src/checks/lib/bundled.js classify) and
...
// per-file library/minified tagging and the non-authored skip set (src/checks/lib/
